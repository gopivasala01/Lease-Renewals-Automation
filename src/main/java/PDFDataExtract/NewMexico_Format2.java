...
public class NewMexico_Format2 
{
	//public static void main(String[] args) 
			public static boolean newMexico() throws Exception
			{
			    ...
			    try
			    {
			    	PDFReader.commencementDate = text.substring(text.indexOf(PDFAppConfig.NewMexico_Format2.commencementDate_Prior)+PDFAppConfig.NewMexico_Format2.commencementDate_Prior.length());
			   ...
			   try
			    {
				   PDFReader.expirationDate = text.substring(text.indexOf(PDFAppConfig.NewMexico_Format2.expirationDate_Prior)+PDFAppConfig.NewMexico_Format2.expirationDate_Prior.length());
