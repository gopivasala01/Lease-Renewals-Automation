...
public class ColoradoSprings_Format2 
{
	//public static void main(String[] args) 
			public static boolean coloradoSprings() throws Exception
			{
			    ...
			    try
			    {
			    	PDFReader.commencementDate = text.substring(text.indexOf(PDFAppConfig.ColoradoSprings_Format2.commencementDate_Prior)+PDFAppConfig.ColoradoSprings_Format2.commencementDate_Prior.length());
			   ...
			   try
			    {
				   PDFReader.expirationDate = text.substring(text.indexOf(PDFAppConfig.ColoradoSprings_Format2.expirationDate_Prior)+PDFAppConfig.ColoradoSprings_Format2.expirationDate_Prior.length());
			   ...
			   try {
				    String[] monthlyRentCandidates = {
				        PDFAppConfig.ColoradoSprings_Format1.monthlyRent_Prior,
				        PDFAppConfig.ColoradoSprings_Format1.monthlyRent_Prior1,
				        PDFAppConfig.ColoradoSprings_Format1.monthlyRent_Prior2
				    };
