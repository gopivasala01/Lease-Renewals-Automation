...
public class OKC_Format2 
{
	//public static void main(String[] args) 
			public static boolean okc() throws Exception
			{
			    ...
			    if(text.contains(PDFAppConfig.OKC_Format2.residentBenefitsPackageCheck)&&(!text.contains("Resident Benefits Package Opt-Out Addendum")||!text.contains("RESIDENT BENEFITS PACKAGE OPT-OUT ADDENDUM")))
			    {
