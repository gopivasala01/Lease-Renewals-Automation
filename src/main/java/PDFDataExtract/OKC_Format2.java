			...
			public static boolean okc() throws Exception
			{
			    ...
			    if(text.contains(PDFAppConfig.OKC_Format2.residentBenefitsPackageCheck)&&!text.contains("Resident Benefits Package Opt-Out Addendum"))
			    {
			    	...
			    	//HVAC Air Filter Fee
			    	 try
					    {
					    	PDFReader.residentBenefitsPackage = text.substring(text.indexOf(PDFAppConfig.OKC_Format2.RBP_Prior)+PDFAppConfig.OKC_Format2.RBP_Prior.length()).trim().split(" ")[0];
