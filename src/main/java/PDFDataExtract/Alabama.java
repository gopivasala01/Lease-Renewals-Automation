...
public class Alabama 
{
	//public static void main(String args[]) throws Exception
		public static void alabama()
		{
			try
			{
		    File file = new File("C:\\SantoshMurthyP\\Lease_1122_1123_13357_Trumpet_Dr_AL_Simpson.pdf");
		    ...
		    {
		    	monthlyRent_Prior = PDFAppConfig.Alabama_Format1.Alabama_monthlyRent_Format1_Prior; // PDFAppConfig.Alabama_monthlyRent_Format1_Prior;
		    	startDate_Prior =  PDFAppConfig.Alabama_Format1.Alabama_startDate_Format1_Prior; //PDFAppConfig.Alabama_startDate_Format1_Prior;
		    	startDate_After = PDFAppConfig.Alabama_Format1.Alabama_startDate_Format1_After;
		    }
		    else if(text.contains(AppConfig.PDFFormatConfirmationText))
		    {
		    	monthlyRent_Prior = PDFAppConfig.Alabama_Format2.Alabama_monthlyRent_Format2_Prior; // PDFAppConfig.Alabama_monthlyRent_Format1_Prior;
		    	startDate_Prior =  PDFAppConfig.Alabama_Format2.Alabama_startDate_Format2_Prior; //PDFAppConfig.Alabama_startDate_Format1_Prior;
		    	startDate_After = PDFAppConfig.Alabama_Format2.Alabama_startDate_Format2_After;
		    } 
		    else 
		    {
