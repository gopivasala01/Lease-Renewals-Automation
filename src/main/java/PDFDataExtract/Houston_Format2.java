	...
	//public static void main(String[] args) 
		public static boolean houston() throws Exception
		{
		   ...
		   System.out.println("Expiration Date = "+PDFReader.expirationDate);
		    ...
		    try
		    {
		    	PDFReader.monthlyRent = text.substring(text.indexOf(PDFAppConfig.Houston_Format2.monthlyRent_Prior2)+PDFAppConfig.Houston_Format2.monthlyRent_Prior2.length()).trim().split(" ")[0];
