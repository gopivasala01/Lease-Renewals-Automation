...
public class Hawaii_Format1 
{
	//public static void main(String[] args) 
			public static boolean hawaii() throws Exception
			{
			    ...
			    try {
			        int commencementIndex = text.indexOf(PDFAppConfig.Hawaii_Format2.commencementDate_Prior) + PDFAppConfig.Hawaii_Format2.commencementDate_Prior.length();
			        int commencementEndIndex = text.indexOf(PDFAppConfig.Hawaii_Format2.commencementDate_After, commencementIndex);
			    ...
			    try {
			        int expirationIndex = text.indexOf(PDFAppConfig.Hawaii_Format2.expirationDate_Prior) + PDFAppConfig.Hawaii_Format2.expirationDate_Prior.length();
			        int expirationEndIndex = text.indexOf(PDFAppConfig.Hawaii_Format2.expirationDate_After, expirationIndex);
			    ...
			    if(text.contains(PDFAppConfig.Hawaii_Format2.residentBenefitsPackageCheck))
			    {
			    	PDFReader.residentBenefitsPackageAvailabilityCheck = true;
			    	//HVAC Air Filter Fee
			    	 try
					    {
					    	PDFReader.residentBenefitsPackage = text.substring(text.indexOf(PDFAppConfig.Hawaii_Format2.RBP_Prior)+PDFAppConfig.Hawaii_Format2.RBP_Prior.length()).trim().split(" ")[0];
