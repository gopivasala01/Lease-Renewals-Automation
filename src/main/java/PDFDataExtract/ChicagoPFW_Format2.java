...
public class ChicagoPFW_Format2 
{
	//public static void main(String[] args) 
			public static boolean chicagoPfw() throws Exception
			{
				try
				{
			   ...
			   try {
				    String[] monthlyRentCandidates = {
				        PDFAppConfig.ChicagoPFW_Format1.monthlyRent_Prior,
				        PDFAppConfig.ChicagoPFW_Format1.monthlyRent_Prior1,
				        PDFAppConfig.ChicagoPFW_Format1.monthlyRent_Prior2
				    };
