	...
	//public static void main(String[] args) 
		public static boolean austin() throws Exception
		{
		   ...
		   System.out.println("Expiration Date = "+PDFReader.expirationDate);
		    ...
		    if(text.contains(PDFAppConfig.Austin_Format2.HVACFilterAddendumTextAvailabilityCheck))
		    {
		    ...
		    if(text.contains(PDFAppConfig.Austin_Format2.residentBenefitsPackageCheck))
		    {
		    	...
		    	//HVAC Air Filter Fee
		    	 try
				    {
				    	PDFReader.residentBenefitsPackage = text.substring(text.indexOf(PDFAppConfig.Austin_Format2.RBP_Prior)+PDFAppConfig.Austin_Format2.RBP_Prior.length()).trim().split(" ")[0];
