...
public class IdahoFalls_Format1 
{
	...
	public static boolean idahoFalls() throws Exception
	{
	    ...
	    try {
	        PDFReader.monthlyRent = extractMonthlyRent(text, PDFAppConfig.IdahoFalls_Format1.monthlyRent_Prior);

	        if (PDFReader.monthlyRent == null || PDFReader.monthlyRent.contains("$")) {
	            PDFReader.monthlyRent = extractMonthlyRent(text, PDFAppConfig.IdahoFalls_Format1.monthlyRent_Prior1);
	        }

	        if (PDFReader.monthlyRent == null || PDFReader.monthlyRent.contains("$")) {
	            PDFReader.monthlyRent = extractMonthlyRent(text, PDFAppConfig.IdahoFalls_Format1.monthlyRent_Prior2);
	        }
