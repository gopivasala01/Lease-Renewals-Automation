...
//public static void main(String[] args)
    ...
    public static void florida() throws Exception
	{
	    ...
	    {
	    	monthlyRent_Prior = PDFAppConfig.Florida_Format1.Florida_monthlyRent_Format1_Prior;
	    	startDate_Prior = PDFAppConfig.Florida_Format1.Florida_startDate_Format1_Prior;
	    	startDate_After = PDFAppConfig.Florida_Format1.Florida_startDate_Format1_After;
	    }
	    else if(text.contains(AppConfig.PDFFormatConfirmationText))
	    {
	    	...
	    	startDate_Prior = PDFAppConfig.Florida_Format2.Florida_startDate_Format2_Prior;
	    	startDate_After = PDFAppConfig.Florida_Format2.Florida_startDate_Format2_After;
	    }
	    else 
	    {
