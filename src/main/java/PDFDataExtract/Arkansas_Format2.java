		   ...
		   System.out.println("Expiration Date = "+PDFReader.expirationDate);
		    ...
		    if(text.contains(PDFAppConfig.Arkansas_Format2.residentBenefitsPackageCheck))
		    {
		    	...
		    	//HVAC Air Filter Fee
		    	 try
				    {
				    	PDFReader.residentBenefitsPackage = text.substring(text.indexOf(PDFAppConfig.Arkansas_Format2.RBP_Prior)+PDFAppConfig.Arkansas_Format2.RBP_Prior.length()).trim().split(" ")[0];
