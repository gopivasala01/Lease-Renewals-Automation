			...
			public static boolean saintLouis() throws Exception
			{
			    ...
			    if(text.contains(PDFAppConfig.SaintLouis_Format2.residentBenefitsPackageCheck)&&!text.contains("Resident Benefits Package Opt-Out Addendum"))
			    {
			    	...
			    	//HVAC Air Filter Fee
			    	 try
					    {
					    	PDFReader.residentBenefitsPackage = text.substring(text.indexOf(PDFAppConfig.SaintLouis_Format2.RBP_Prior)+PDFAppConfig.SaintLouis_Format2.RBP_Prior.length()).trim().split(" ")[0];
