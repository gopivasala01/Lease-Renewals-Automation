...
public class SaintLouis_Format2 
{
	//public static void main(String[] args) 
			public static boolean saintLouis() throws Exception
			{
			    ...
			    try
			    {
			    	PDFReader.commencementDate = text.substring(text.indexOf(PDFAppConfig.SaintLouis_Format2.commencementDate_Prior)+PDFAppConfig.SaintLouis_Format2.commencementDate_Prior.length());
			   ...
			   try
			    {
				   PDFReader.expirationDate = text.substring(text.indexOf(PDFAppConfig.SaintLouis_Format2.expirationDate_Prior)+PDFAppConfig.SaintLouis_Format2.expirationDate_Prior.length());
			   ...
			   try {
				    String[] monthlyRentCandidates = {
				        PDFAppConfig.SaintLouis_Format1.monthlyRent_Prior,
				        PDFAppConfig.SaintLouis_Format1.monthlyRent_Prior1,
				        PDFAppConfig.SaintLouis_Format1.monthlyRent_Prior2
				    };
