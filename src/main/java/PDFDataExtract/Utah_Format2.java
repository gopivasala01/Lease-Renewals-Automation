	...
	public static boolean utah() throws Exception
	{
	    ...
	    if (text.contains(PDFAppConfig.Boise_Format1.residentUtilityBillTextCheck)) 
	    {
	        ...
	        try 
	        {
	            ...
	            } else if (text.indexOf(PDFAppConfig.Boise_Format1.RUBS_Prior2) != -1) 
	            {
	            ...
	            } else if (text.indexOf(PDFAppConfig.Boise_Format1.RUBS_Prior3) != -1) 
	            {
	                PDFReader.RUBS = text.substring(text.indexOf(PDFAppConfig.Boise_Format1.RUBS_Prior3) + PDFAppConfig.Boise_Format1.RUBS_Prior3.length()).trim().split(" ")[0];
	            } else 
	            {
	                PDFReader.RUBS = text.substring(text.indexOf(PDFAppConfig.Utah_Format2.RUBS_Prior4) + PDFAppConfig.Utah_Format2.RUBS_Prior4.length()).trim().split(" ")[0];
	            }
	        } catch (Exception e) 
	        {
