		...
		public static boolean californiapfw() throws Exception
		{
		   ...
		   try {
			    String[] monthlyRentCandidates = {
			        PDFAppConfig.California_PFW_Format1.monthlyRent_Prior,
			        PDFAppConfig.California_PFW_Format1.monthlyRent_Prior1,
			        PDFAppConfig.California_PFW_Format1.monthlyRent_Prior2
			    };
