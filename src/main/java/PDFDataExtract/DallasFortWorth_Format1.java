		...
		public static boolean dallasFortWorth() throws Exception
		{
		    ...
		    System.out.println("Last date mentioned on the page: " + PDFReader.renewalExecutionDate);
			   ...
			   System.out.println("Expiration Date = "+PDFReader.expirationDate);
			    ...
			    String text2 = text.substring(text.indexOf(PDFAppConfig.DallasFortWorth_Format1.RBPCHeck_Prior)+PDFAppConfig.DallasFortWorth_Format1.RBPCHeck_Prior.length()).trim();
