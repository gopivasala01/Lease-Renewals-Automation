		   ...
		   System.out.println("Expiration Date = "+PDFReader.expirationDate);
		    ...
		    if(text.contains(PDFAppConfig.Maine_Format2.residentBenefitsPackageCheck))
		    {
		    	...
		    	//HVAC Air Filter Fee
		    	 try
				    {
				    	PDFReader.residentBenefitsPackage = text.substring(text.indexOf(PDFAppConfig.Maine_Format2.RBP_Prior)+PDFAppConfig.Maine_Format2.RBP_Prior.length()).trim().split(" ")[0];
